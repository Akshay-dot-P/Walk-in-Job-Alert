...
USER_PROMPT_PREFIX = (
    ...
    "      If it's recent (<30 days) and not senior, score it 8-10. "
    ...
    "1:    AUTO-REJECT: (a) Senior/Lead/Manager/II/III/2/3+ roles, 5+ years required. "
    "      (b) Posted >30 days ago.\n\n"
    "IMPORTANT RULES:\n"
    ...
    "- Entry-level (0-4 years or no experience mentioned)\n"
    "- Posted ≤30 days\n"
